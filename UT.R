...
summary = summary %>%
          ...
          dplyr::mutate(date=as.Date(date), lookahead=date-forecast_date, model_name=model, location_short=case_when(is.na(location_short) ~ "USA", 
                        ...
                        prediction_type="90_PI", gt_source=case_when(forecast_date <= as.Date("2020-05-05") ~ "NYT", forecast_date > as.Date("2020-05-05") ~ "JHU"),
                        perc_0.010=NA, perc_0.025=NA, perc_0.100=NA, perc_0.150=NA, perc_0.200=NA, perc_0.250=NA, perc_0.300=NA, perc_0.350=NA, perc_0.400=NA, 
                        perc_0.450=NA, perc_0.500=NA, perc_0.550=NA, perc_0.600=NA, perc_0.650=NA, perc_0.700=NA, perc_0.750=NA, perc_0.800=NA, perc_0.850=NA, 
                        perc_0.900=NA, perc_0.975=NA, perc_0.990=NA) %>%
          filter(forecast_date < date) %>%
          rename_at(vars(c("date", "daily_deaths_est", "daily_deaths_90CI_lower", "daily_deaths_90CI_upper")), ~ c("target_end_date", "expected_value", "perc_0.050", "perc_0.950"))
summary = summary[,c(2,1,7,8,3,9,4,11,12,5,13:29,6,30,31,10)]
